...
public class BuyerDashboardRedirectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!orders.isEmpty()){
            System.out.println("retrived orders");
            for(Order order:orders){
                order.printDetails();
            }
        }
        
        System.out.println("retrived products and orders");
        ...
        System.out.println("Attributes are set as well");
